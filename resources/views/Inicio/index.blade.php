...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="index.html">LLATA</a></h1>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>GEOGRAFIA</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li class="dropdown"><a href="#"><span>COCHAPATA</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="#">CHAVIN</a></li>
                  <li><a href="#">PUÑOS</a></li>
                  <li><a href="#">TANTAMAYO</a></li>
                  <li><a href="#">SINGA</a></li>
                  <li><a href="#">MONZON</a></li>
                </ul>
              </li>
              <li><a href="#">JIRCAN</a></li>
              <li><a href="#">JACAS GRANDE</a></li>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-up">
      <h1>Visite Llata</h1>
      <h2>Una tierra noble y hospitalaria</h2>
      <a href="#about" class="btn-get-started scrollto">Te esperamos!</a>
    </div>
  </section><!-- End Hero -->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-6 col-lg-6 video-box d-flex justify-content-center align-items-stretch" data-aos="zoom-in">
            <a href="https://www.youtube.com/watch?v=cPGpkVHxogY&t=29s" class="venobox play-btn mb-4" data-vbtype="video" data-autoplay="true"></a>
          </div>
    ...
    <section id="faq" class="faq">
      <div class="container">
        ...
        <div class="section-title" data-aos="zoom-in">
          ...
          <p>Piruro (posiblemente del quechua para tortera) es un sitio arqueológico en Perú. ​ ​ Declarado Patrimonio Cultural Nacional por Resolución Directoral Núm. 533/INC el 18 de junio de 2002. </p>
        </div>

        <div class="faq-list">
          <ul>
            <li data-aos="fade-up">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">¿Porque visitar Piruro? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                <p>
                  Es la cuna de america una de las culturas mas antiguas del Perú, tiene una riqueza en su fauna y si aun no haz visitado que esperas.
                </p>
              </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="100">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">CONTINENTE <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="200">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">CORDILLERAS <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="300">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">VALLE <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="400">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-5" class="collapsed">ECORREGION <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          ...
          <div class="col-lg-4" data-aos="fade-right">
            <div class="info">
              <div class="address">
                ...
                <h4>Localizacion:</h4>
                <p>Llata, Provincia de Huamalíes, Huanuco</p>
              </div>
